...
const faveColors = ['orange', 'black', 'grey']
...
const me = {
    firstName: 'Todd',
    superHeroName: 'Bad Coding Guy',
    homeTown: 'Tulsa, OK',
    superPowers: ['Slow Typing', 'Bad Comprehension', 'Easily Frustated'],
...
function setColor(arr) {
    ...
    for (let i = 0; 0 < arr.length; i++) {
        if (faveColors.includes('blue')) {
            faveColors.splice(i, 1) && faveColors.push('#4D4DFF');
        }
    }
    background('orange', 'black', 'grey');
}
//////////////////Step 5////////////////////
